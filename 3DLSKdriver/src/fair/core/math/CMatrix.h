...
public:
   ...
   */
  CMatrix44(const CVector4 &v0, const CVector4 &v1, 
      const CVector4 &v2, const CVector4 &v3) {
    col[0] = v0;
    col[1] = v1;
    col[2] = v2;
    col[3] = v3;
...
CMatrix44    LookAtMatrix44(const CVector3 &camPos, const CVector3 &camUp, 
    const CVector3 &target );
CMatrix44    FrustumMatrix44(float l, float r, float b, float t, 
    float n, float f);
CMatrix44    PerspectiveMatrix44(float fovY, float aspect, 
    float n, float f);
CMatrix44    OrthoMatrix44(float l, float r, float b, float t, 
    float n, float f);
